                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><div  class="underline text-gray-900 dark:text-white">Assumptions</div></div>
                            </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><div class="underline text-gray-900 dark:text-white">Tech Stacks</div></div>
                            </div>
                            ...
                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    <ul>
                                        ...
                                        <li>Packages: Jetstream,Livewire </li>
                                        <li>Design Patterns: Repository Design Pattern</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><div class="underline text-gray-900 dark:text-white">Create a custom README.md</div></div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    We strongly recommend creating a custom README.md. We've provided a template inside
                                    the README-template.md file in this starter code.
                                    The template provides a guide for what to add. A custom README will help you explain your
                                    project. Please feel free to edit our template as much as you like.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">Working Functionalities</div>
                            </div>
                                ...
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            request. Once submitted, the reviewer cannot resubmit the feedback for the same
                                            request.
                                        </li>
                                    </ul>
                                </div>
